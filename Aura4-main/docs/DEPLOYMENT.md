...
Проект закреплён на npm: в репозитории используется `package-lock.json`, а pnpm-lock-файл удалён, чтобы Railway не выбирал pnpm для native-зависимости Tailwind.
